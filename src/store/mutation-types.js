...
export const TOGGLE_IP = 'ip'
export const TOGGLE_CLIENT_SIZE = 'client_size'
export const TOGGLE_PRODUCT_CODE = 'productCode'
export const TOGGLE_HEADER_FLAG = 'header_flag'
